...
RISU は **v0.1.0 のベータ**です．正直に書くと，次の状態です．

- 動作を確認しているのは **Windows 11 / Python 3.13 / Chrome** だけです
- Linux と Python 3.10〜3.12 は CI の設定に入っていますが，**実績はまだありません**
- macOS はサポート対象外です

そのため，**「動いた」「動かなかった」の報告がいちばん価値があります**．
とくに Linux で試された方は，結果がどちらでも Issue で教えていただけると助かります．
